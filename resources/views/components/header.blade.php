<nav class="bg-white fixed top-0 left-0 w-full z-10 shadow-sm p-2">
      <div class="mx-auto max-w-7xl px-0.5 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between">
          ...
          <a href="{{ route('/') }}">
          <img
            class="h-auto w-12 sm:w-10 lg:w-14"
            src="images/logo.png"
            alt="Your Company"
            />
          </a>
          ...
          <div
            class="flex absolute inset-y-0 left-1/2 transform -translate-x-1/2 lg:hidden"
          >
            <button
              type="button"
          ...
          >
            <div class="relative">
              ...
              >
                ...
                <a
                  href="#"
                  class="block px-4 py-2 text-sm text-[#47404f] cursor-pointer"
                  role="menuitem"
                  tabindex="-1"
                  id="user-menu-item-0"
